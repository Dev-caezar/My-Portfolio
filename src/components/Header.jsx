...
const Header = () => {
  ...
  return (
    <div className="fixed w-full h-[10vh] md:h-[20vh] flex justify-end md:justify-center items-center z-50 p-4">
      <div
        className={`hidden md:flex w-[60%] h-[80%] rounded-full shadow-md justify-around items-center px-8 ${currentTheme.container}`}>
      ...
      {isMenuOpen && (
        <div
          className={`absolute top-[18vh] left-1/2 -translate-x-1/2 w-[80%] max-w-sm rounded-lg shadow-md z-40 py-4 ${currentTheme.mobileMenu}`}>

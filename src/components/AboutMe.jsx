...
import { SiJavascript, SiRedux, SiTailwindcss, SiExpo } from "react-icons/si";
  ...
  return (
    ...
    >
      <div className="w-full max-w-4xl px-4 text-center">
        ...
        >
          <p>
            I am Oko Christian, a frontend and aspiring mobile developer with a
            passion for building innovative solutions. With over 2 years of
            experience in software engineering, I've developed a strong
            foundation in problem-solving and a keen interest in staying
            up-to-date with industry trends.
          </p>
          <p>
            My expertise lies in React, React Native, and Tailwind CSS, and I am
            always eager to expand my skill set. I have had the privilege of
            working on various projects, from personal initiatives to
            collaborative endeavors, showcasing my adaptability and commitment
      ...
      >
        {technologies.map((tech, index) => (
          ...
          >
            <div
              className={`p-3 sm:p-4 rounded-full border-2 shadow-md ${
                isDarkMode
